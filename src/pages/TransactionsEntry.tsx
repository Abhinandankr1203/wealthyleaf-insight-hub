...
const dummyData = [
  ...
  { date: "2024-06-03", type: "Buy", scheme: "Axis Midcap Fund", amount: "₹3,000" },
];
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col flex-1 min-h-screen">
        ...
        <main className="flex-1 p-8">
          <h1 className="text-2xl font-bold mb-6">Transactions Entry</h1>
          <div className="w-full max-w-4xl mx-auto mt-8">
            <div className="shadow-md rounded-xl w-full bg-white p-6">
              <div className="flex flex-wrap gap-4 mb-4 justify-center">
                ...
                <button onClick={() => { setSelectedDate(""); setSelectedType(""); setSelectedScheme(""); setSelectedAmount(""); }} className="ml-2 px-3 py-2 rounded bg-gray-200 hover:bg-gray-300 text-gray-700">Reset</button>
              </div>
