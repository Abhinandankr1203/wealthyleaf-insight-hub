...
const dummyData = [
  { scheme: "Axis Midcap Fund", gain: "₹800", asOf: "2024-06-10" },
  { scheme: "HDFC Equity Fund", gain: "₹1,200", asOf: "2024-06-10" },
];

const barData = [
  { fund: "Axis Midcap Fund", gain: 800 },
  { fund: "HDFC Equity Fund", gain: 1200 },
  { fund: "ICICI Bluechip Fund", gain: 600 },
];
...
export default function CapitalGainUnrealized() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-green-50 via-blue-100 to-green-100">
      ...
      <main className="flex-1 p-8">
        <h1 className="text-2xl font-bold mb-6">Capital Gain Unrealized</h1>
        {/* Charts Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          {/* Bar Chart for Unrealized Gains by Fund */}
          <Card className="shadow-md rounded-xl">
            <CardHeader>
              <CardTitle className="text-base font-medium text-gray-500">Unrealized Gains by Fund</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          {/* Line Chart for Trend in Unrealized Gains */}
          <Card className="shadow-md rounded-xl">
            <CardHeader>
              <CardTitle className="text-base font-medium text-gray-500">Unrealized Gains Trend</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="w-full h-64">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={lineData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Line type="monotone" dataKey="gain" stroke="#10B981" strokeWidth={3} dot={{ r: 5 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
            ...
            <table className="w-full table-auto border-collapse bg-white rounded-lg overflow-hidden shadow">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="p-3 text-left font-bold">Unrealized Gain</th>
                  <th className="p-3 text-left font-bold">As of</th>
                </tr>
              </thead>
              <tbody>
