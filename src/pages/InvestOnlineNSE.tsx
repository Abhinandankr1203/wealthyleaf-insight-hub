...
const dummyData = [
  { order: "Buy", scheme: "HDFC Equity Fund", amount: "₹5,000", date: "2024-06-10" },
  { order: "Sell", scheme: "ICICI Bluechip Fund", amount: "₹2,000", date: "2024-06-12" },
];
...
export default function InvestOnlineNSE() {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col flex-1 min-h-screen">
        ...
        <main className="flex-1 p-8">
          <h1 className="text-2xl font-bold mb-6">Invest Online NSE</h1>
